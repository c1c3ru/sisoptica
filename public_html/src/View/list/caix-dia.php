...
$caixa_hoje      = $caixaController->getCaixa($caixa_id);
...
?>
<h4 class="title-form"> Lista de Despesas do Caixa Diário de <?php echo $config->maskData($caixa_hoje->data);?> </h4>
<div class="separted-info">
    <table style="text-align: center; width: 100%;">
        <thead>
            <tr>
                ...
                <th class="same-info"><label>Operações</label></th>
            </tr>
        </thead>
        <tbody>
    <?php
    ...
    $img_del = "<img src='" . GRID_ICONS . "remover.png' title='Remover Despesa'>";
    $img_edit = "<img src='" . GRID_ICONS . "editar.png' title='Editar Despesa'>";
    ...
    foreach ($despesas as $despesa) {
        ...
        if($natureza->id != NaturezaDespesaController::ID_DESPESA_CAIXA) {
            $link_del = "<a href=\"javascript:;\" onclick=\"deleteDespesa({$despesa->id})\" class=\"ask\" ask=\"deletar\" >$img_del</a>";
            $link_edit = "<a href=\"javascript:;\" onclick=\"openEditDespesaMode({$despesa->id})\">$img_edit</a>";
            $operations = "$link_del&nbsp;&nbsp;&nbsp;&nbsp;$link_edit";
        } else {
            $operations = "";
        }
        ...
        echo '<td class=\'any-info\'><span>'.$operations.'</span></td>';
        
        echo '</tr>';
    }
    
    echo '<tr><th class=\'same-info\' colspan=\'6\'><label>Itens de Prestação de Conta</label></th></tr>';
    ...
    foreach($itens as $item){ 
        ...
        echo '<td class=\'any-info\'><span></span></td>';
        echo '</tr>';
