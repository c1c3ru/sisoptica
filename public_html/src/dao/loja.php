...
class LojaModel extends Database {
     ...
     */
//    public function insert($loja, $debug = false)
//    {
...
//        unset($values["id"], $values["telefones"]);
//        $values = Database::turnInValues($values);
//        $res = parent::insert(self::TABLE, $fields, $values, $debug);
//        if ($res) {
//            return $this->getAnnalisses()->lastInsertedId();
//        }
//        return null;
//    }
//
    ...
    {
        $res = parent::insert($table, $fields, $values, $debug);
        if ($res) {
            return $this->getAnnalisses()->lastInsertedId();
        }
        return null;
     ...
     * @return PDOStatment lista de lojas do tipo Loja.
     */
...
//    }
    ...
    public function superSelect($condition = null)
    {
        $fields = array(
            ...
            self::SIGLA,
            self::TABLE . "." . self::RUA,
            self::TABLE . "." . self::NUMERO,
            self::TABLE . "." . self::BAIRRO,
            self::TABLE . "." . self::CEP,
            self::CNPJ,
            CidadeModel::NOME,
            self::CGC,
     ...
     * @return PDOStatment true em caso de sucesso na atualização ou false em caso de falha
     */
//    public function update(Loja $loja, $debug = false)
//    {
//        $dic = array(
...
//        );
//
//        $condition = self::ID . " = " . $loja->id;
//        return $this->update(self::TABLE, $dic, $condition, $debug);
//    }
    public function update($table, $fields, $values, $condition = null, $debug = false) {
        global $loja;
        $dic = array(
            self::SIGLA => $loja->sigla,
            self::RUA => $loja->rua,
        ...
        return parent::update(self::TABLE, $fields, $values, $condition, $debug);
    }
...
//        $id_loja = '';
//        $condition = self::ID . " = $id_loja";
//        return $this->delete(self::TABLE, $condition, $no_fk_check, $debug);
//    }
    public function delete($table, $condition, $no_fk_check = false, $debug = false) {
