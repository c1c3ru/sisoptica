...
function addTelefone(){
    ...
    row += "<input type='text' class='input text-input' name='telefone-"+(++telefones_count) +
           "' maxlength='15' id='telefone-"+telefones_count+"' style='width:70%' onkeypress='MascaraTelefone(this)'/>";
