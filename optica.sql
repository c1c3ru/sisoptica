...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 27/02/2024 às 12:47
...
--
ALTER TABLE `marca_produto`
  MODIFY `id_marca_produto` tinyint(3) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `produto`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1000033;
